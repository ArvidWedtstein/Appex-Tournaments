...
<template>
  <main class="overflow-x-hidden fixed w-full h-full left-0 bottom-0 p-8 flex flex-row items-center flex-nowrap transition-all duration-500 ease-in-out select-none">
    ...
    <transition name="fade">
      <div v-if="showTournamentScreen" class="fixed bottom-0 top-0 left-0 pt-12 z-[2] bg-appexbackclr text-appexblack flex flex-col content-center justify-center">
        ...
        <div class="flex flex-auto content-center items-center rounded bg-appexdarkgrey px-auto">
          <div class="flex content-center items-center">
