<template>
  <div class="relative mx-auto my-auto flex flex-col content-center justify-center align-center">
    ...
    <nuxt-link to="/tournaments" class="p-6 bg-appexblack hover:bg-appexorange text-appexorange font-semibold hover:text-black my-8 py-4 px-8 border border-transparent hover:border-black rounded transition-all duration-300 ease-linear">Sett turnering på pause</nuxt-link>
  </div>
</template>
